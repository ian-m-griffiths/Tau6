...
**Status:** STATED-UNPROVED — T2a is `decide`-closable; T2b needs a finite case split
(suggestion below). This is the first goal to give the prover agent
(proofs/AGENTS.md workflow: T2 first).
-/
